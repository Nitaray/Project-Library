...
int MyLibrary::LibraryContext::makeBorrow(int sid, int cid)
{
	...
	newBorrow.Title.Id = title->Id;
	newBorrow.Title.Name = title->Name;
	newBorrow.Title.Author = title->Author;
...
int MyLibrary::LibraryContext::releaseBorrow(int sid, int cid)
{
	...
	releaseLog.Title.Id = title->Id;
	releaseLog.Title.Name = title->Name;
	releaseLog.Title.Author = title->Author;
